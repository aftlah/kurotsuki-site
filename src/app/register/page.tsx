...
// Logo element justification: Register page uses Seigaiha waves (bg), Crescent Moon (glow), Circular Crest (card). Brand tokens only.
    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 opacity-[0.03]">
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
          <defs>
            <pattern id="seigaiha-register" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
          ...
          <rect width="100" height="100" fill="url(#seigaiha-register)" />
        </svg>
      </div>
      ...
      >
        <Card className="p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-white-soft mb-2">Join the Society</h1>
            <p className="text-gray-muted">Create your account</p>
          </div>

          <form className="space-y-6">
            <div>
              <label className="block text-sm font-medium text-gray-muted mb-2">Username</label>
              <input
                type="text"
